// COSYlanguages A0-A1 Communication Manual Shared JS
(function(){
 "use strict";
 function initTTS(){
 ...
 function initChecklists(){
   document.querySelectorAll('.checklist[data-key]').forEach(function(box){
     var key = 'cosy-fr-comm-check-' + box.getAttribute('data-key');
     var stored = {};
     ...
     function updateProgress(){
       ...
       if(prog) prog.textContent = done + ' / ' + items.length + ' compétences validées';
     }
