...
> **Note on Architecture:** For an overview of how the CEFR HTML manuals interlock with the machine-readable JSON reference layer, see [`CONTENT_ARCHITECTURE.md`](../../../../CONTENT_ARCHITECTURE.md) at the repository root.
